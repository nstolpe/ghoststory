...
//			);
			...
			add(new Entity()
				...
				.add(new SpotLightComponent(new SpotCaster(new Color(0f, 0f, 1f, 1f), new Vector3(20, 6, 20), new Vector3(0f, -0.5f, -1f), 40f, 90f, 10f), true, true))
				.add(new DirectionComponent(new Vector3(0f, -1f, -1f)))
				.add(new BehaviorComponent())
				.add(new GeometryComponent().file("cube.g3dj"))
			);
//			// lights 4
