package com.hh.ghoststory.Override.graphics.g3d.shaders;
...
public class DefaultShader extends BaseShader {
	...
	public static String getDefaultVertexShader () {
		if (defaultVertexShader == null)
			defaultVertexShader = Gdx.files.internal("shaders/override/default.vertex.glsl").readString();
	...
	public static String getDefaultFragmentShader () {
		if (defaultFragmentShader == null)
			defaultFragmentShader = Gdx.files.internal("shaders/override//default.fragment.glsl").readString();
